...
from models import make_cassnat2_model
from utils.wer import ctc_greedy_wer, att_greedy_wer

class Config():
    name = 'config'

class CASSNAT2Task(BaseTask):
    def __init__(self, mode, args):
        ...
        super(CASSNAT2Task, self).__init__(args)
    ...
    def set_model(self, args):
        ...
        self.model = make_cassnat2_model(args.input_size, args)
    ...
    def run_one_epoch(self, epoch, args, is_train=True):
        ...
        for i, data in enumerate(dataloader):
            ...
            ctc_out, att_out, loss, ctc_loss, att_loss, interce_out = self.model(src, src_mask, feat_sizes, tgt_label, label_sizes, self.tokenizer, self.text_encoder_tokenizer, self._num_updates, args)
            ...
            interce_errs, all_tokens = att_greedy_wer(interce_out, tgt_label.cpu().numpy(), args.padding_idx)
