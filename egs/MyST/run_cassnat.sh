...
asr_exp=exp/myst_sp_sptokenizer_cassnat_initart_noam_warmup25k_lrpk1e-3_epoch60_2gpus/
...
if [ $stage -le 1 ] && [ $end_stage -ge 1 ]; then
  ...
  CUDA_VISIBLE_DEVICES="2,3" train_asr.py \
    ...
    --seed 1234 \
    --print_freq 100 \
    --port 12344 >> $asr_exp/train.log 2>&1 &
...
if [ $stage -le 2 ] && [ $end_stage -ge 2 ]; then
  last_epoch=30  # need to be modified
...
if [ $stage -le 3 ] && [ $end_stage -ge 3 ]; then
  ...
  rnnlm_model=exp/myst_sp_sptokenizer_cfmer_interctc05_layer6_noam_warmup25k_lrpk1e-3_epoch60_2gpus//averaged.mdl
  ...
  for tset in $test_set; do
    ...
    $cmd JOB=1:$nj $desdir/log/decode.JOB.log \
      CUDA_VISIBLE_DEVICES=2 decode_asr.py \
        ...
        --utt2num_frames data/$tset/utt2num_frames \
